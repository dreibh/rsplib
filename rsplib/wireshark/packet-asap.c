...
proto_register_asap(void)
{
  ...
  static hf_register_info hf[] = {
    ...
    { &hf_policy_load,            { "Policy Load",                 "asap.pool_member_selection_policy_load",        FT_FLOAT,   BASE_DEC,  NULL,                             0x0,                       "", HFILL } },
    { &hf_policy_degradation,     { "Policy Degradation",          "asap.pool_member_selection_policy_degradation", FT_FLOAT,   BASE_DEC,  NULL,                             0x0,                       "", HFILL } },
    { &hf_policy_loaddpf,         { "Policy Load DPF",             "asap.pool_member_selection_policy_load_dpf",    FT_FLOAT,   BASE_DEC,  NULL,                             0x0,                       "", HFILL } },
    { &hf_policy_weightdpf,       { "Policy Weight DPF",           "asap.pool_member_selection_policy_weight_dpf",  FT_FLOAT,   BASE_DEC,  NULL,                             0x0,                       "", HFILL } },
