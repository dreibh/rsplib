...
createHistogram <- function(data, timeOffsetVector, queuingStart, queuingEnd, title)
{
...
pdf("test6.pdf", width=10, height=7.5, onefile=TRUE, family="Helvetica", pointsize=18)

createHistogram(data, timeOffsetVector, 1, 14, "Normal Operation I")
createHistogram(data, timeOffsetVector, 16, 29, "Failure in Asia")
createHistogram(data, timeOffsetVector, 31, 45, "Added Backup Capacity")
createHistogram(data, timeOffsetVector, 46, 49, "Failure Resolved")
createHistogram(data, timeOffsetVector, 51, 64, "Normal Operation II")
